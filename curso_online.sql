...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 25-05-2025 a las 16:54:54
...
ALTER TABLE `inscripciones`
  ...
  ADD CONSTRAINT `inscripciones_ibfk_3` FOREIGN KEY (`horario_id`) REFERENCES `horarios` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
